...
public class CodeCallVO {
	...
	private String sawonGb;
	
	private String sawonNm;
	
	private String cmpGb;
	...
	public String getSawonGb() {
		return sawonGb;
	}

	public void setSawonGb(String sawonGb) {
		this.sawonGb = sawonGb;
	}
	...
	public String getCmpGb() {
		return cmpGb;
	}

	public void setCmpGb(String cmpGb) {
		this.cmpGb = cmpGb;
	}
	...
	public String toString() {
		return "CodeCallVO [codegb=" + codegb + ", codenm=" + codenm
				+ ", codeno=" + codeno + ", registid=" + registid + ", AllYn="
				+ AllYn + ", AllCode=" + AllCode + ", AllName=" + AllName
				+ ", useYn=" + useYn + ", sort=" + sort + ", classcode="
				+ classcode + ", sawonGb=" + sawonGb + ", sawonNm=" + sawonNm
				+ ", cmpGb=" + cmpGb + ", cmpNm=" + cmpNm + ", eqmType="
				+ eqmType + ", searchText=" + searchText + ", codeFull="
				+ codeFull + "]";
	}
